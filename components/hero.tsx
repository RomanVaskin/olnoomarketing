  ...
  return (
    <section id="top" className="pt-16">
      ...
      <div className="fade-up mx-auto max-w-[1400px] px-5 md:px-10">
        <h1 className="mt-6 text-balance text-[length:min(calc((100vw_-_2.5rem)/12.5),3rem)] font-normal leading-none tracking-[-0.035em] text-[#777777] md:whitespace-nowrap md:text-[length:min(calc((100vw_-_5rem)/17.5),48px)] lg:text-[length:clamp(48px,4.4vw,68px)]">
          Маркетинг и продажи
          <br />
